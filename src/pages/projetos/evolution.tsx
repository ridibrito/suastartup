    ...
    <>
      ...
      <div className="p-12 flex border-b ">
        ...
        <div className="max-w-3xl mx-auto flex justify-center ">
          <h1 className=" text-4xl">Evolution API</h1>
        </div>
      </div>
      <div className="p-12 max-w-7xl mx-auto">
        <p>
          Seja bem vindo a instalação da Evolution API, siga o passo a passo a
        ...
        <div className="mt-3">
          ...
          <div className="mt-2">
            <span>Backend : (Ex: api.seucliente.seudominio.com)</span>
            <Clip />
          </div>
        </div>
      </div>
